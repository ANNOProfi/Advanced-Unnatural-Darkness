...
namespace AUD
{
    public class QuestNode_Root_AdvancedUnnaturalDarkness : QuestNode
    {
        ...
        private static readonly FloatRange MainPhaseDurationDaysRange = new FloatRange(AUD_Utilities.Settings.minDuration, AUD_Utilities.Settings.maxDuration);
        ...
        protected override void RunInt()
        {
            ...
            if(!AUD_Utilities.Settings.infiniteUnnaturalDarkness)
            {
