...
namespace AUD
{
    public class QuestPart_AdvancedNoctoliths : QuestPart
    {
        ...
        public QuestPart_AdvancedNoctoliths()
        {
        }

        public QuestPart_AdvancedNoctoliths(MapParent mapParent, List<Thing> noctoliths, float points, string inSignalNoctolithDamaged, string inSignalNoctolithKilled)
        {
